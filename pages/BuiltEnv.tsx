...
export const BuiltEnv: React.FC = () => {
  return (
    <div className="bg-obsidian min-h-screen">
      ...
      {/* 1. Hero Section */}
      <Section spacing="none" dividerBottom className="pt-32 pb-20">
        <Container className="max-w-5xl">
          <Reveal>
            <Eyebrow className="text-focus mb-4">Selective Advisory</Eyebrow>
      ...
      {/* 2. Who This Is For */}
      <Section className="bg-surface border-b border-white/5">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            ...
            <Reveal delay={70} className="grid grid-cols-1 gap-6">
              {[
      ...
      <Section className="border-b border-white/5">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Reveal className="bg-surface p-8 border border-white/5 rounded-sm hover:border-white/20 transition-colors">
            ...
            <Reveal delay={70} className="bg-surface p-8 border border-white/5 rounded-sm hover:border-white/20 transition-colors">
              <div className="w-12 h-12 bg-obsidian border border-white/10 flex items-center justify-center mb-6 text-structural">
                <Scale size={24} />
              </div>
      ...
      <Section className="bg-surface border-b border-white/5">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Model 1 */}
            <Reveal className="bg-obsidian border border-white/10 p-8 rounded-sm">
            ...
            {/* Model 2 */}
            <Reveal delay={70} className="bg-obsidian border border-white/10 p-8 rounded-sm">
               <div className="flex items-center gap-4 mb-6">
            ...
            {/* Boundaries */}
            <Reveal delay={140} className="bg-obsidian border border-white/10 p-8 rounded-sm relative overflow-hidden">
      ...
      <Section className="border-b border-white/5">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <Reveal className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
